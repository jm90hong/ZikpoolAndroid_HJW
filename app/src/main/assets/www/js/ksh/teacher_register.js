...
function init(){
  ...
  //todo 가장먼저 수잘친선생님 신청에 관한 내용 참고 하라고 알림창 띄우기.
  if(tr_obj.pageType=='normal'){
    zikpoolAlert({
        title:'신청하기 전에',
        content:"수잘친선생님은 대학교 재학 이상의<br/>학력을 가진 회원이 할 수 있습니다.<br/>신청하기 전에 반드시 아래의<br/>'수잘친선생님 신청에 관하여'를 참고하시길 바랍니다."
      });
  }else if(tr_obj.pageType=='edit'){
    zikpoolAlert({
        title:'수잘친 선생님 재신청',
        content:'수잘친운영팀에서 신청서를 검토한 결과 입력한 정보가<br/>'
    ...
    zikpoolAlert({
            title:'수잘친 선생님 정보 수정',
            content:'선생님 정보 수정시 수잘친운영팀에서<br/>확인 절차가 이루어집니다.<br/>'
