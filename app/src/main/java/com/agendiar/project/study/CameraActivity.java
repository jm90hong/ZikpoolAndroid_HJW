...
import com.agendiar.project.camera.CameraPreview;
import com.agendiar.project.model.CameraActivityModel;



public class CameraActivity extends AppCompatActivity implements CameraActivityModel.OnCameraListener{
...
// Enable the Up button
        ...
        text.setText("내용(글자)이 잘 보이게 찍어주세요");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK && requestCode == PICTURE_TYPE_GALLERY) {
            if (data != null) {
                ...
                Intent i = new Intent(CameraActivity.this,ImageAndCropActivity.class);
