...
public class CashHisActivity extends AppCompatActivity {
...
// Enable the Up button
        ...
        mXWalkView.addJavascriptInterface(new JavascriptCashHis(), "android_cashhis");
        mXWalkView.loadUrl("file:///android_asset/www/"+url);
    }

    public class JavascriptCashHis{
