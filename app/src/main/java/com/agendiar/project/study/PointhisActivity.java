...
public class PointhisActivity extends AppCompatActivity {
...
// Enable the Up button
        ...
        mXWalkView.addJavascriptInterface(new JavascriptPoint_his(), "android_point_his");
        mXWalkView.loadUrl("file:///android_asset/www/"+url);
    }

    public class JavascriptPoint_his{
        ...
        public void questiondetail_go(String url){
            Intent intent = new Intent(PointhisActivity.this, QuestionDetailActivity.class);
