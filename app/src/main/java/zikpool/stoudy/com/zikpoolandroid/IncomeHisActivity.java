...
public class IncomeHisActivity extends AppCompatActivity {
...
// Enable the Up button
        ...
        mXWalkView.addJavascriptInterface(new JavascriptIncome_his(), "android_income_his");
    ...
    public class JavascriptIncome_his{
        ...
        public void questiondetail_go(String url){
            Intent intent = new Intent(IncomeHisActivity.this, QuestionDetailActivity.class);
