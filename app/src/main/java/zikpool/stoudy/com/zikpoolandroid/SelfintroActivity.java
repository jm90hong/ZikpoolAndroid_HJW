...
// Enable the Up button
        ...
        mXWalkView.addJavascriptInterface(new JavascriptSelf_intro(), "android_self_intro");
    ...
    public class JavascriptSelf_intro{
        ...
        @android.webkit.JavascriptInterface
        public void completeUpdateSelfIntro(){
            UserInfoModel.getInstance().triggerSelfintroToUserinfo();
            zikpoolToast("수정 완료");
            finish();
        }
